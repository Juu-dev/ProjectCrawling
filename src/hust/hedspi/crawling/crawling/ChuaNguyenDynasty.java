...
public class ChuaNguyenDynasty extends CrawlingFigure {

	@SuppressWarnings("unchecked")
	public static void main(String[] args) throws IOException {
		JSONArray list = new JSONArray();
		Document doc = crawl("https://vi.wikipedia.org/wiki/Th%E1%BB%83_lo%E1%BA%A1i:V%C3%B5_t%C6%B0%E1%BB%9Bng_ch%C3%BAa_Nguy%E1%BB%85n");
		...
		for (Element e : Figures) {
			...
			FigureInfo.put("job", "Võ tướng của chúa Nguyễn");
			FigureInfo.put("dynasty", "Trịnh - Nguyễn phân tranh");
			JSONObject newFigure = new JSONObject();
			newFigure.put(name, FigureInfo);
			list.add(newFigure);
		}
		doc = crawl("https://vi.wikipedia.org/wiki/Th%E1%BB%83_lo%E1%BA%A1i:Quan_l%E1%BA%A1i_ch%C3%BAa_Nguy%E1%BB%85n");
		...
		for (Element e : Figures) {
			...
			FigureInfo.put("historicalEvents", null);
			FigureInfo.put("isKing", "false");
			FigureInfo.put("job", "Quan lại chúa Nguyễn");
			FigureInfo.put("dynasty", "Trịnh - Nguyễn phân tranh");
			JSONObject newFigure = new JSONObject();
			newFigure.put(name, FigureInfo);
			list.add(newFigure);
