...
public class LyDynasty extends CrawlingFigure {
	...
	public static void main(String[] args) throws IOException {
		...
		doc = crawl("https://vi.wikipedia.org/wiki/Th%E1%BB%83_lo%E1%BA%A1i:C%C3%B4ng_ch%C3%BAa_nh%C3%A0_L%C3%BD");
		...
		doc = crawl("https://vi.wikipedia.org/wiki/Th%E1%BB%83_lo%E1%BA%A1i:Vua_nh%C3%A0_L%C3%BD");
		Figures = doc.select("div.mw-category-group > ul > li > a");
		int i=0;
		for (Element e : Figures) {
			++i;
		...
		doc = crawl("https://vi.wikipedia.org/wiki/Th%E1%BB%83_lo%E1%BA%A1i:Ho%C3%A0ng_t%E1%BB%99c_nh%C3%A0_L%C3%BD");
		Figures = doc.select("div.mw-category-group > ul > li > a");
		i=0;
		for (Element e : Figures) {
			++i;
		...
		doc = crawl("https://vi.wikipedia.org/wiki/Th%E1%BB%83_lo%E1%BA%A1i:Quan_l%E1%BA%A1i_nh%C3%A0_L%C3%BD");
		Figures = doc.select("div.mw-category-group > ul > li > a");
