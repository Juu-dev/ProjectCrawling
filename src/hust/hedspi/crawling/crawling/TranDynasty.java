...
public class TranDynasty extends CrawlingFigure {

	@SuppressWarnings("unchecked")
	public static void main(String[] args) throws IOException {
		JSONArray list = new JSONArray();
		Document doc = crawl("https://vi.wikipedia.org/wiki/Th%E1%BB%83_lo%E1%BA%A1i:V%C3%B5_t%C6%B0%E1%BB%9Bng_nh%C3%A0_Tr%E1%BA%A7n");
		...
		for (Element e : Figures) {
			...
			FigureInfo.put("dynasty", "Nhà Trần");
			JSONObject newFigure = new JSONObject();
			newFigure.put(name, FigureInfo);
			list.add(newFigure);
		}
		doc = crawl("https://vi.wikipedia.org/wiki/Th%E1%BB%83_lo%E1%BA%A1i:C%C3%B4ng_ch%C3%BAa_nh%C3%A0_Tr%E1%BA%A7n");
		Figures = doc.select("div.mw-category-group > ul > li > a");
		int i=0;
		for (Element e : Figures) {
			++i;
			if (i==5 || i==8 || i==9 || i==10 || i==15 ) continue;
			JSONObject FigureInfo = new JSONObject();
			String url ="https://vi.wikipedia.org"+e.attr("href");
			String name = e.attr("title");
			FigureInfo.put("name",name);
		...
		doc = crawl("https://vi.wikipedia.org/wiki/Th%E1%BB%83_lo%E1%BA%A1i:Ho%C3%A0ng_t%E1%BB%AD_nh%C3%A0_Tr%E1%BA%A7n");
		Figures = doc.select("div.mw-category-group > ul > li > a");
		...
		doc = crawl("https://vi.wikipedia.org/wiki/Th%E1%BB%83_lo%E1%BA%A1i:Vua_nh%C3%A0_Tr%E1%BA%A7n");
		Figures = doc.select("div.mw-category-group > ul > li > a");
		i=0;
		for (Element e : Figures) {
			++i;
		...
		doc = crawl("https://vi.wikipedia.org/wiki/Th%E1%BB%83_lo%E1%BA%A1i:Ho%C3%A0ng_t%E1%BB%99c_nh%C3%A0_Tr%E1%BA%A7n");
		Figures = doc.select("div.mw-category-group > ul > li > a");
		i=0;
		for (Element e : Figures) {
			++i;
		...
		doc = crawl("https://vi.wikipedia.org/wiki/Th%E1%BB%83_lo%E1%BA%A1i:Quan_l%E1%BA%A1i_nh%C3%A0_Tr%E1%BA%A7n");
		Figures = doc.select("div.mw-category-group > ul > li > a");
		i=0;
		for (Element e : Figures) {
			++i;
